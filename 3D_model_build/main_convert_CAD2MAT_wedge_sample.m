...
importGeometry(model,'Wedge_1-5deg_200_200.stl');% Construct the Geometry
%
...
bracketThickness = 5; % Thickness of horizontal plate with hole, meters
...
%% save file
save ('model_wedge_200_200_1_5deg_5mesh.mat', 'model_mesh_nei');
%save('test.mat')