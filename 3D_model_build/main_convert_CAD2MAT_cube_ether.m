...
importGeometry(model,'cube_110.stl');% Construct the Geometry
...
bracketThickness = 20; % Thickness of horizontal plate with hole, meters
...
%% save file
save ('model_cube_110_20mesh.mat', 'model_mesh_nei');
%save('test.mat')