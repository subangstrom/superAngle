...
importGeometry(model,'cubic_200_200_200_chamferedge_10.stl');% Construct the Geometry
...
bracketThickness = 12.5; % Thickness of horizontal plate with hole, meters
...
p(1,:)=p(1,:)-(max_x+min_x)/2;
p(2,:)=p(2,:)-(max_y+min_y)/2;
p(3,:)=p(3,:)-(max_z+min_z)/2;
...
model_mesh.t=t;
model_mesh.p=p;
model_mesh.filename='model_sample.mat';
...
%% save file
save ('model_cube_200_200_200_12.5mesh.mat', 'model_mesh_nei');
%save('test.mat')