function [ output, output_omega, output_counts ] = single_spot_3D( TiltX, TiltY, Detector, sample_para, holder_para, SpuriousX, model_sample, model_ether, model_connect,ether_start_p)
...
if (chk_contact==1) %have interception with sample  
    ...
    [ model_slice ] = slice_model( model_sample, model_ether, model_connect, sample_para,ether_start_p, 1, 1);
    %pause(0.2);
