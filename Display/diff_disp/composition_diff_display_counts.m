function [ ] = composition_diff_display_counts( Ne, tau, chk_print, comp_ratio_out, sample_para, chkX_Y )
...
y_wt_err = min(0.5,max(0.1,max(max(abs(diff_wt(:,2:temp_size2(2)))))*1.2));
