function [  ] = sample_PosXY_display2_counts( Pos_map, chk_print, Detector, sample_para, search_PosX, d_PosX, search_PosY, d_PosY )
...
for i=1:tot_Det_num
    figure;
    set(gca,'FontSize',15)
    imagesc (image_rangeX, image_rangeY, A_map(:,:,i)./B_map(:,:,i)*convert_factor_A/convert_factor_B), axis image;
...
figure
set(gca,'FontSize',15)
imagesc (image_rangeX, image_rangeY, ratio_map), axis image;
