function [ comp_ratio_out ] = composition_cal( exp_file, Detector, sample_para, holder_para, SpuriousX, chkX_Y )
...
[ ~, ~, ~, ~, ~, ~, ratio_exp, ratio_exp_all, tot_Det_num] = read_exp_data( exp_file );
