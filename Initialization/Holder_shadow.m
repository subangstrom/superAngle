function [ H_angle_out ] = Holder_shadow(sample_para, holder_para, angle_search_in)
%Main code to calculate holder shadow and absorption effect
%Weizong Xu, April, 2015, wxu4@ncsu.edu

if (holder_para.Cal_side_effect>0)
    [angle_search_level1] = Holder_grid_shadow_up(sample_para, holder_para, angle_search_in);  
    [angle_search_level2] = Holder_frame_shadow_fast_up(sample_para, holder_para, angle_search_level1);
