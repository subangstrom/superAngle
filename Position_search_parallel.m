function [ Al_out, Ni_out, Absrp_out, Xray_num_out] = Position_search_parallel(search_Range, d_Range, sample_para, holder_para, holder_frame_para, angle_search, Spurious)
...
for j=1:tot_search
    ...
    [Al_outX, Ni_outX] = PositionX_search_parallel(search_Range, d_Range, sample_para, holder_para, holder_frame_para, angle_search, Spurious, chk);
    Al_out(:,j)=Al_outX(:,2);
    Ni_out(:,j)=Ni_outX(:,2);
